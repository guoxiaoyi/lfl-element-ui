...
<script type="text/babel">
  import { getRangeHours, getRangeMinutes, modifyTime } from 'lfl-element-ui/src/utils/date-util';
  import ElScrollbar from 'lfl-element-ui/packages/scrollbar';
  import RepeatClick from 'lfl-element-ui/src/directives/repeat-click';
