...
<script>
import Popper from 'lfl-element-ui/src/utils/vue-popper';
import Clickoutside from 'lfl-element-ui/src/utils/clickoutside';
import Emitter from 'lfl-element-ui/src/mixins/emitter';
import Locale from 'lfl-element-ui/src/mixins/locale';
import Migrating from 'lfl-element-ui/src/mixins/migrating';
import ElInput from 'lfl-element-ui/packages/input';
import ElTag from 'lfl-element-ui/packages/tag';
import ElScrollbar from 'lfl-element-ui/packages/scrollbar';
import ElCascaderPanel from 'lfl-element-ui/packages/cascader-panel';
import AriaUtils from 'lfl-element-ui/src/utils/aria-utils';
import { t } from 'lfl-element-ui/src/locale';
import { isEqual, isEmpty, kebabCase } from 'lfl-element-ui/src/utils/util';
import { isUndefined, isFunction } from 'lfl-element-ui/src/utils/types';
import { isDef } from 'lfl-element-ui/src/utils/shared';
import { addResizeListener, removeResizeListener } from 'lfl-element-ui/src/utils/resize-event';
