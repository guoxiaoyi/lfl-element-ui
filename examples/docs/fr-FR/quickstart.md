...
```javascript
import Vue from 'vue';
import ElementUI from 'lfl-element-ui';
import 'lfl-element-ui/lib/theme-chalk/index.css';
...
```javascript
import Vue from 'vue';
import { Button, Select } from 'lfl-element-ui';
import App from './App.vue';
...
```js
import Vue from 'vue';
import { Button } from 'lfl-element-ui';
